        ...
        const pages = {
            ...
            'ibpr': `
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    <h1 class="text-2xl font-bold text-gray-900 mb-4">IBPR</h1>
                    <p class="text-gray-700">Ini adalah halaman untuk IBPR (Informasi Bentuk dan Posisi Rambu).</p>
                </div>
            `,
            'bentuk': `
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    <h1 class="text-2xl font-bold text-gray-900 mb-4">Bentuk - Bentuk</h1>
                    <p class="text-gray-700">Ini adalah halaman untuk Bentuk - Bentuk.</p>
                </div>
            `,
            'penjagaan': `
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    <h1 class="text-2xl font-bold text-gray-900 mb-4">Penjagaan Counter KR dan SM</h1>
                    <p class="text-gray-700">Ini adalah halaman untuk Penjagaan Counter KR dan SM.</p>
                </div>
            `,
            'gangguan': `
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
        ...
        document.getElementById('submenu-bentuk').addEventListener('click', () => loadPage('bentuk'));
        document.getElementById('submenu-penjagaan').addEventListener('click', () => loadPage('penjagaan'));
